...
async function EditRentalPage({ params }: { params: { id: string } }) {
  ...
  const defaultAmenities: Amenity[] = await JSON.parse(property.amenities);

  return (
    <section>
      <h1 className='text-2xl font-semi-bold mb-8 capitalize'>Edit Property</h1>
      <div className='border p-8 rounded-r-md'>
        <ImageInputContainer
